...
Version  : 2.0.2
Release  : 12
URL      : https://github.com/steve-m/librtlsdr/archive/v2.0.2/librtlsdr-2.0.2.tar.gz
Source0  : https://github.com/steve-m/librtlsdr/archive/v2.0.2/librtlsdr-2.0.2.tar.gz
...
%prep
%setup -q -n librtlsdr-2.0.2
cd %{_builddir}/librtlsdr-2.0.2
pushd ..
cp -a librtlsdr-2.0.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713906367
